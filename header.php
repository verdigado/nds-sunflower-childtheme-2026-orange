...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		...
		<?php
		// Theme only supports personal header, so we can directly load the template part without checking the option value.
		get_template_part( 'template-parts/header', 'personal' );
		?>
